...
.banner-container {
    position: relative;
    width: 100vw;
    height: 75vh; /* Fills a majestic 75% of the viewing screen, leaving room for scroll indicators */
    ...
    function animate() {
        ...
        waveColors.forEach((color, index) => {
            ...
            for (let i = 0; i < canvas.width; i++) {
                const y = canvas.height / 2 + Math.sin(i * frequency + increment + (index * 2)) * amplitude;
                ctx.lineTo(i, y);
            }
...
### Welcome to WAVESLAB
This is where the standard lab descriptive text begins. Your non-coding team members can start writing right here using plain Markdown text syntax below the banner engine.